...
import { IstStudyTeamOrganizationViewModalComponent } from './ist-study-team-organization-view-modal/ist-study-team-organization-view-modal.component';
import { DeleteBoxComponent } from 'src/app/common/delete-box/delete-box.component';

@Component({
  selector: 'app-ist-study-team-organization',
  templateUrl: './ist-study-team-organization.component.html',
  styleUrls: ['./ist-study-team-organization.component.scss']
})
export class IstStudyTeamOrganizationComponent implements OnInit {
  ...
  setSummary() {
    this.summaryService.getStudyTeamOrganizationSummary().subscribe(summary => {
