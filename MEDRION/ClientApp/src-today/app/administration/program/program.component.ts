...
export class ProgramComponent implements OnInit {
  ...
  onRowDoubleClicked(event) {
    this.modalService.show(ProgramViewModalComponent, {
      backdrop: true,
      keyboard: false,
  ...
  add() {
    let modalRef = this['self'].modalService.show(ProgramViewModalComponent, {
      backdrop: true,
      keyboard: false,
      ignoreBackdropClick: true,
      class: 'modal-md modal-full-height modal-right',
  ...
  view() {
    this['self'].modalService.show(ProgramViewModalComponent, {
      backdrop: true,
      keyboard: false,
      ignoreBackdropClick: true,
      class: 'modal-md modal-full-height modal-right',
  ...
  setSummary() {
    this.summaryService.getProgramSummary().subscribe(summary => {
