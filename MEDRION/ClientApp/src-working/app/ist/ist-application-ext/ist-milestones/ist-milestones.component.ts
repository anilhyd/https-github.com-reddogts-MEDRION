...
import { IstMilestonesViewModalComponent } from './ist-milestones-view-modal/ist-milestones-view-modal.component';
import { DeleteBoxComponent } from 'src/app/common/delete-box/delete-box.component';

@Component({
  selector: 'app-ist-milestones',
  templateUrl: './ist-milestones.component.html',
  styleUrls: ['./ist-milestones.component.scss']
})
export class IstMilestonesComponent implements OnInit {
  ...
  onRowDoubleClicked(event) {
    this.modalService.show(IstMilestonesViewModalComponent, {
      backdrop: true,
      keyboard: false,
  ...
  add() {
    let modalRef = this['self'].modalService.show(IstMilestonesViewModalComponent, {
      backdrop: true,
      keyboard: false,
      ignoreBackdropClick: true,
      class:'modal-llg modal-full-height modal-right',
  ...
  setSummary() {
    this.summaryService.getMilestonesSummary().subscribe(summary => {
