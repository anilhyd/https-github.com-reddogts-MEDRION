...
@Component({
  selector: 'app-grants-document-upload-sponsorship',
  templateUrl: './grants-document-upload-sponsorship.component.html',
  styleUrls: ['./grants-document-upload-sponsorship.component.scss']
})
export class GrantsDocumentUploadSponsorshipComponent implements OnInit {
