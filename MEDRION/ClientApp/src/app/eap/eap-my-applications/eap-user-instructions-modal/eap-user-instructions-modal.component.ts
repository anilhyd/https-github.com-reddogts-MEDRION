...
export class EapUserInstructionsModalComponent implements OnInit {
  ...
  add() {
    ...
    this.router.navigate(['/home/eap/my-applications/application-ext/:0/program_info'], {skipLocationChange:true, queryParams:{module:"eap", id:0, app_ext:true, screen_type:"my-applications"}})
  }
