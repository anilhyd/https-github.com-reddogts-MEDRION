...
import { PolicyConfiguratorModalComponent } from './policy-configurator-modal/policy-configurator-modal.component';

@Component({
  selector: 'app-policy-configurator',
  templateUrl: './policy-configurator.component.html',
  styleUrls: ['./policy-configurator.component.scss']
})
export class PolicyConfiguratorComponent implements OnInit {
  ...
  ngOnInit() {
    this.criteriaService.getPolicyConfiguratorCriteria().subscribe(criteria => {
      ...
      this.summaryService.getPolicyConfiguratorSummary().subscribe(summary=>{
 ...
 onRowDoubleClicked(event) {
  this.modalService.show(PolicyConfiguratorModalComponent, {
    backdrop: true,
    keyboard: false,
 ...
 edit() {
  this["self"].modalRef = this['self'].modalService.show(PolicyConfiguratorModalComponent, {
    backdrop: true,
    keyboard: false,
    ignoreBackdropClick: true,
